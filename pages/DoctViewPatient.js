...
import DoctPatientDetails from './DoctPatientDetails'

const DoctViewPatient = (props) => {
    ...
    if(aadharstatus==1){
    return <DoctPatientDetails Doctassined={props.Doctassined} aadhar={nv}></DoctPatientDetails>
       
    }
}

export default DoctViewPatient